...
### 1.1b Load Market Context
Check for `templates/MARKET-CONTEXT.md` in the project directory.

**If found:**
- Load local tool signatures and add them to the tech stack detection list
- Load relationship norms — pass to Agent 5 (strategy) to calibrate outreach tone
- Load funding signal equivalents — pass to Agent 3 (opportunity) to calibrate budget scoring
- Load local competitor landscape — pass to Agent 4 (competitive)
- Note in the discovery briefing: "Market context loaded — agents calibrated for [markets]"

**If not found:**
- Proceed with US/Western B2B defaults
- No action needed
